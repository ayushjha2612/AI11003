...
\begin{align}
    \text{Total no. of bulbs } &= 100  \\
      \text{No. of non-defective bulbs }  &= 100 -5 \\
                                           &=95 
\end{align}
The batch is accepted $\iff $ all 4 chosen bulbs are non defective. 
\begin{equation}
      \text{No. of ways to choose 4 bulbs } = {100 \choose 4} 
\end{equation}
  \begin{equation}
       \text{No. of ways to choose 4 non-defective bulbs } = {95 \choose 4}
  \end{equation}
   Therefore we have, probability that batch is selected i.e., 
 \begin{align}
     \Pr\brak{X=1} &= \frac{{95 \choose 4}}{{100 \choose 4}}  \\
                   &= \frac{95 \times 94 \times 93 \times 92}{100 \times 99 \times 98 \times 97} \\
                   &= 0.812
 \end{align}
Therefore, the probability that the current batch is accepted is $0.812 $. \\
