...
\item
For a small positive epislon, $ \epsilon $, we have conditional PDF as, 
\begin{align}
    f_{Y|X}(y | a- \epsilon \le x \le a) &= \frac{f_{XY}(x,y )}{f_X(x)} \\
    & = \frac{8xy}{4x(1-x^2)}  \\
    & = \frac{2y}{1-x^2}
\end{align}
The conditional CDF is defined as
\begin{align}
   & F_{Y|X}(Y \le y | a- \epsilon \le X \le a)  \\
   & = \Pr\brak{Y\le y |a- \epsilon \le X \le a } \\
   & = \int_{-\infty}^{y}  f_{Y|X}(y | a- \epsilon \le x \le a)  \,dy 
\end{align}
Therefore,
\begin{align}
  & \Pr\brak{a- \epsilon \le Y\le a |a- \epsilon \le X \le a } \\
  & = \int_{a- \epsilon}^{a}  f_{Y|X}(y | a- \epsilon \le x \le a)  \,dy  \\
  & = \int_{a- \epsilon}^{a}  \frac{2y}{1-x^2}  \,dy \\ 
  & = \frac{a^2 - (a- \epsilon)^2}{1- x^2}
\end{align}
Now, we have that
\begin{align}
     &  \Pr\brak{a- \epsilon \le Y\le a |a- \epsilon \le X \le a } \\
     & = \frac{\Pr\brak{a- \epsilon \le Y\le a , a- \epsilon \le X \le a } }{\Pr\brak{a- \epsilon \le X \le a }}
     \label{eq1}
\end{align}
As $ \epsilon \to 0 $ we have,
\begin{align}
    &\lim_{\epsilon \to 0} \Pr\brak{a- \epsilon \le Y\le a |a- \epsilon \le X \le a } \\ 
    & = \lim_{\epsilon \to 0} \frac{a^2 - (a- \epsilon)^2}{1- x^2} \\
    & = \lim_{\epsilon \to 0} \frac{2a\epsilon - \epsilon^2}{1- x^2} \\
    & = 0
    \label{eq2}
\end{align}
So by \eqref{eq1} and  \eqref{eq2} we have,
\begin{align}
   &\lim_{\epsilon \to 0}  \Pr\brak{a- \epsilon \le Y\le a , a- \epsilon \le X \le a } \\
   & = 0
\end{align}
