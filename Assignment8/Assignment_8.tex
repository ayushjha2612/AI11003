...
f_{X}(x)  = 
\begin{cases}
\dfrac{\lambda^{\alpha}x^{\alpha-1}e^{-\lambda x}}{(\alpha-1)!} &  x > 0
\\
0 & otherwise
\end{cases}
\end{align}
...
\end{align}
Using a well known result from integration by parts which is,
\begin{align}
    \int_{0}^{\infty} x^a e^{-bx}\,dx = \dfrac{a!}{b^{a+1}}
\end{align}
Therefore using this property we have,
\begin{align}
    M_X(s) & = \dfrac{\lambda^3}{2} \times \dfrac{2!}{(\lambda- s)^3}\\
    &= \brak{\dfrac{\lambda}{\lambda-s}}^3  \\
    &= \brak{\dfrac{\lambda}{\lambda-s}}^\alpha  \text{, for $\alpha = 3 $}
\end{align}
Therefore the MGF of $ X $ is same as the MGF of gamma distribution. \\
So from the theorem, the distribution of $ X$ is gamma distribution, i.e. $ X \sim \Gamma(\alpha,\lambda)$ with PDF,
\begin{align}
f_{X}(x)  = 
\begin{cases}
\dfrac{\lambda^{\alpha}x^{\alpha-1}e^{-\lambda x}}{(\alpha-1)!} &  x > 0
...
with pdf,
\begin{align}
    f_T(t)= \dfrac{\lambda^{3n} t^{3n-1}e^{-\lambda t}}{(3n-1)!} , t>0
\end{align}
Using, $ \dfrac{1}{\Bar{X}} = \dfrac{n}{T}$
\begin{align}
   & E \left[   \dfrac{1}{\Bar{X}}  \right] =  \int_{0}^{\infty} \dfrac{n}{t} \dfrac{1}{(3n-1)!} \lambda^{3n}t^{3n-1}e^{-\lambda t}\,dt \\
    &= \dfrac{n\lambda}{(3n-1)} \int_{0}^{\infty}  \dfrac{1}{(3n-2)!} \lambda^{3n-1}t^{3n-2}e^{-\lambda t}\,dt 
\end{align}
...
So we have,
\begin{align}
    \int_{0}^{\infty}  \dfrac{1}{(3n-2)!} \lambda^{3n-1}t^{3n-2}e^{-\lambda t}\,dt = 1
\end{align}
\begin{align}
...
\item 
 ...
 \end{align}
 \begin{align}
    &  E \left[   {\dfrac{1}{\Bar{X}}}^2  \right] = \int_{0}^{\infty} \dfrac{n^2}{t^2} \dfrac{1}{(3n-1)!} \lambda^{3n}t^{3n-1}e^{-\lambda t}\,dt \\
      &= \dfrac{n^2\lambda^2}{(3n-1)(3n-2)} \times (1)
 \end{align}
 As from property of gamma distribution we have,
 \begin{align}
     \int_{0}^{\infty} \dfrac{1}{(3n-3)!} \lambda^{3n-2}t^{3n-3}e^{-\lambda t}\,dt = 1
 \end{align}
Therefore,
\begin{align}
