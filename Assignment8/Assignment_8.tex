...
\begin{corollary}
\label{expxi}
The expected value of $ \dfrac{1}{X_i} $ with distribution of X from equation \eqref{pdf} is calculated by  substituting $ n=1 $ in lemma \ref{expected} as,
 \begin{align}
...
\begin{corollary}
\label{varxi}
The variance of $ \dfrac{1}{X_i} $ with distribution of X from equation \eqref{pdf} is calculated by 
substituting $ n=1 $ in lemma \ref{varxbar} as,
\begin{align}
