...
Let probability that a randomly selected person is in favour be $\Pr(Favour)$ and if he is in oppose is $\Pr(oppose)$. \\
So we have that, 
70\% of people are in favour thus, \\ $\Pr(favour)=70/100$ and 30\% are in oppose so $\Pr(oppose)= 30/100$. \\ 
X=0 if he opposed the proposal, and X=1 if he is in favour.\\
Therefore, we have
\begin{align*}
E(X)    & = \sum P_iX_i \\
         &= 0 \times \Pr (oppose)+1 \times \Pr(favour)\\
...
\begin{align*}
    E(X^2)  & = \sum  P_iX_i^2    \\
        &= 0^2 \times \Pr (oppose) + 1^2 \times \Pr(favour)\\ 
        &= 70/100  \\
        &= 0.7
\end{align*}
So we have finally,
